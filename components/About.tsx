      ...
      <div className="mt-40 border-t border-[#292929]">
        <div className="grid md:grid-cols-12 py-12">
          <div className="md:col-span-3 mb-8 md:mb-0">
            <span className="text-[12px] font-semibold text-white/40 uppercase tracking-widest" style={{ fontFamily: 'Switzer, sans-serif' }}>(Skills)</span>
          </div>
          <div className="md:col-span-9 space-y-20">
            {skills.map((skill, idx) => (
              ...
              >
                ...
                <span className="text-[14px] font-mono text-white/30 hidden md:block mt-1">
                  {skill.num}
                </span>
              </motion.div>
            ))}
